export const servicesSection = {
  ...
  intro:
    'Each engagement targets a specific, high-impact problem \u2014 backed by PhD-level methodology and proven commercial results. Every engagement is scoped and quoted individually.',
};
...
export const services = [
  ...
  },
  {
    ...
    value: 'Your print farm is losing 10\u201330% revenue to failed prints, rework, and slow throughput. We audit your operation, implement proven standardized protocols, and train your team.',
    bullets: [
      { bold: 'Expected ROI', text: '20\u201340% throughput increase within 90 days' },
  ...
  },
  {
    ...
    bullets: [
      ...
      { bold: 'Engagement', text: 'Retainer model (3-month) or commission-based (3\u20135% of equipment cost).' },
    ],
  },
  {
    id: 'research',
  ...
  },
  {
    id: 'fractional',
    icon: 'external',
    badge: 'Part-Time \u00b7 Strategic',
    title: 'Fractional Technical COO/CTO',
    body: 'Part-time strategic technical leadership for scaling AM operations. Embedded in your team for sustained operational discipline.',
    what: 'Part-time (10\u201320 hours/week) strategic technical leadership. Embedded in your team to drive operational discipline, process governance, and manufacturing strategy.',
    value: 'You need senior AM technical leadership but can\u2019t justify a full-time hire. Get CTO/COO-level strategic guidance without the overhead.',
    bullets: [
      { bold: 'Experience', text: 'Former Technical Operations Lead reporting to CEO. Managed R&D, production, quality, sales, and after-sales.' },
      { bold: 'Engagement', text: '10\u201320 hours/week. Scoped per engagement. Embedded in your team for sustained operational discipline.' },
    ],
  },
];
